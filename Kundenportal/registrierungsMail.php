    ...
    $mail->Body    = "
            ...
            <body>
                <div style='background-color: #f4f4f4; padding: 20px;'>
                    ...
                    <p style='color: #666;'>Liebe/r <?php echo htmlspecialchars($vorname); ?> <?php echo htmlspecialchars($nachname); ?></p>
                    <p style='color: #666;'>Ab sofort können Sie sich mit Ihrem Benutzernamen <?php echo htmlspecialchars($benutzername); ?> in unserem Kundenportal einloggen!</p>
